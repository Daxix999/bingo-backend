...
const generarPDF = async (tablas, plantilla, tablasPorPagina = 1, nombreArchivo) => {
    ...
    try {
        ...
        // En Render necesita argumentos adicionales para funcionar
        // ------------------------------------------------------------
        ...
        // Si hay una ruta de ejecutable definida (útil para producción)
        if (process.env.PUPPETEER_EXECUTABLE_PATH) {
            puppeteerOptions.executablePath = process.env.PUPPETEER_EXECUTABLE_PATH;
        }
        
        // Iniciar Puppeteer con la configuración adecuada
